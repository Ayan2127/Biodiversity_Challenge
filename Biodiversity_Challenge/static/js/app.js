let url =
    ...
    d3.json(url).then(function (jsonData) {
     ...
     // Create default webpage visualizations using the first option in the dropdown list.
     // This will help users identify the types of visualizations 
     ///and guide them in selecting options.  
      let defaultName = data.names[0];
